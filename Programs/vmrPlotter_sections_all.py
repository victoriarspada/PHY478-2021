...
def vmrPlotter_sections_ALL(cm_pair,regression_title,regression_labels):
    ...
    for i in range(0,len(cm_pair),1):
        a0_1 += cm_pair[i].meas[0][0]
        a1_1 += cm_pair[i].meas[0][1]
        a0e_1 += cm_pair[i].meas_errors[0][0]
        a1e_1 += cm_pair[i].meas_errors[0][1]
        a0_alt_1 += cm_pair[i].meas_altitudes[0][1]

        a0_2 += cm_pair[i].meas[1][0]
        a1_2 += cm_pair[i].meas[1][1]
        a0e_2 += cm_pair[i].meas_errors[1][0]
        a1e_2 += cm_pair[i].meas_errors[1][1]
        a0_alt_2 += cm_pair[i].meas_altitudes[1][1]

        a0_3 = cm_pair[i].meas[2][0]
        a1_3 += cm_pair[i].meas[2][1]
        a0e_3 = cm_pair[i].meas_errors[2][0]
        a1e_3 += cm_pair[i].meas_errors[2][1]
        a0_alt_3 += cm_pair[i].meas_altitudes[2][1]
