...
def vmrPlotter(cm_pair,cm,regression_title,abs_diff_title,regression_labels,year):
    ...
    if type(abs_diff_title)==str: # Add title.
        ax2.set_title(abs_diff_title,y=1.05) # Pad title to fit in scale for y axis.
        filenamepng = abs_diff_title + ".png" # Create name for png plot file.
    else:
        filenamepng = 'Absolute Differences 2011.png'
