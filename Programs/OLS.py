# -*- coding: utf-8 -*-
"""
Created on Wed Jun 17 09:36:42 2020

@author: Victoria Spada
contact: victoria.spada@mail.utoronto.ca
Last edited: July 29 2020.
"""
# Ordinary Least Squares Linear Regression solver.
# Input: X and Y number arrays to be checked for correlation. 
# Output: slope m, y-intercept b, Pearson correlation coefficient R, and Root Mean Square Deviation (RMSD) for the input pair: X and Y.
